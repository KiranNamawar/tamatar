...
export type introspection_types = {
    'AuthPayload': { kind: 'OBJECT'; name: 'AuthPayload'; fields: { 'accessToken': { name: 'accessToken'; type: { kind: 'SCALAR'; name: 'String'; ofType: null; } }; 'refreshToken': { name: 'refreshToken'; type: { kind: 'SCALAR'; name: 'String'; ofType: null; } }; }; };
    'Boolean': unknown;
    'DateTime': unknown;
    'ID': unknown;
    'Mutation': { kind: 'OBJECT'; name: 'Mutation'; fields: { 'google': { name: 'google'; type: { kind: 'OBJECT'; name: 'AuthPayload'; ofType: null; } }; 'login': { name: 'login'; type: { kind: 'OBJECT'; name: 'AuthPayload'; ofType: null; } }; 'logout': { name: 'logout'; type: { kind: 'SCALAR'; name: 'Boolean'; ofType: null; } }; 'refresh': { name: 'refresh'; type: { kind: 'SCALAR'; name: 'String'; ofType: null; } }; 'resetPassword': { name: 'resetPassword'; type: { kind: 'SCALAR'; name: 'Boolean'; ofType: null; } }; 'sendOtp': { name: 'sendOtp'; type: { kind: 'SCALAR'; name: 'Boolean'; ofType: null; } }; 'signup': { name: 'signup'; type: { kind: 'SCALAR'; name: 'Boolean'; ofType: null; } }; 'verify': { name: 'verify'; type: { kind: 'OBJECT'; name: 'AuthPayload'; ofType: null; } }; }; };
    ...
    'Query': { kind: 'OBJECT'; name: 'Query'; fields: { 'test': { name: 'test'; type: { kind: 'SCALAR'; name: 'String'; ofType: null; } }; 'user': { name: 'user'; type: { kind: 'OBJECT'; name: 'User'; ofType: null; } }; }; };
