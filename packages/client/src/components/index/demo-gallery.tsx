...
import { Heart, GitCommit, Smartphone, Globe, Database, Cpu } from "lucide-react";
  ...
  return (
    <section className="relative w-full py-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center mb-12">
        ...
        >
          Real developers sharing their journey, building amazing projects, and growing together.
        </motion.p>
      </div>
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1">
                <div className="font-bold text-base text-gray-800 dark:text-gray-100">{d.user}</div>
                <div className="text-xs text-purple-600 dark:text-purple-400">{d.project}</div>
              </div>
              <Badge className="text-xs bg-gradient-to-r from-orange-500 to-pink-500 text-white">
                {d.badge}
              </Badge>
            </div>
