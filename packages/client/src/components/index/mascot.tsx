...
export default function PixelLaptopModernMascot() {
  // Animation state for the bouncing dot
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        {/* Laptop body */}
        <rect x="7" y="10" width="18" height="13" rx="2" fill="#d1d5db" stroke="#374151" strokeWidth="0.5" />
        {/* Laptop screen frame */}
        ...
        <rect x="16" y="25" width="2" height="2" rx="0.7" fill={glow ? "#22c55e" : "#14532d"} />
      </svg>
      <span className="mt-2 text-xs font-mono text-blue-700 dark:text-blue-300">Modern Laptop</span>
    </div>
  );
}
